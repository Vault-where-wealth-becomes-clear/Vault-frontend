      ...
      <div style={{ position: "relative", zIndex: 1, display: "flex", width: "100%", height: "100%" }}>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontSize: 10, letterSpacing: "0.2em", color: "rgba(255,255,255,0.4)" }}>VAULT</span>
          </div>
        ...
        >
          ...
          <p style={{ fontSize: 10, color: "rgba(255,255,255,0.2)", textAlign: "center", marginTop: 14, marginBottom: 0 }}>
